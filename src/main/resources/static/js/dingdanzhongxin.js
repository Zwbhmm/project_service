new Vue({
    ...
    methods:{
        ...
        getOrderByUser:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getMsoByUserid',{
                params:{
                    //当前页数
        ...
        getMsoxq:function (msoid) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getMsoxqByMsoid/' + msoid, {
                params:{
                    //初始化的时候当前页数先赋值为1
                    currentPage:1
                }
        ...
        getMsoCountByUserid:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getMsoCountByUserid')
                .then(function (response) {
                    //给我们的产品总数进行赋值
        ...
        isPayOrNot:function (msoid,totalMoney) {
            ...
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/pay/getPayState/' + msoid)
                .then(function (response) {
                    //给我们的产品总数进行赋值
        ...
        payMoney:function (msoid,totalMoney) {
            ...
            axios.get('/project_service/pay/payMoney',{
                params:{
                    msoid:msoid,            //订单号
        ...
        getLoginUser:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/user/getUser')
                .then(function (response) {
