new Vue({
    ...
    methods:{
        ...
        getCart:function () {
            ...
            var _this = this;
            axios.get('/project_service/cart/getCart')
        ...
        deleteProById:function (proid) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.delete('/project_service/cart/deleteProById/' + proid)
                .then(function (response) {
                    alert(response.data);
        ...
        getCount:function (proid,count) {
            ...
            if (count > 0){
                ...
                axios.get('/project_service/cart/updateCartPro', {
                    params:{
                        proid_update:proid,
                        count_update:count
                    }
        ...
        clearAll:function () {
            ...
            if (pros != null && pros.length > 0){
                ...
                // console.log(_this.ids);
                axios.delete('/project_service/cart/clearCart', {
                    params:{
        ...
        addToOrder:function () {
            ...
            //把当前购物车的产品添加到订单中心
            axios.get('/project_service/order/addToOrder',{
                params:{
        ...
        getTotalMoney:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/cart/getCartTotalMoney')
                .then(function (response) {
                    //赋值总价
