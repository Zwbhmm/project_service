...
import com.project.service.shopService.OrderService;
import com.project.model.shopEntity.Mso;
import com.project.model.shopEntity.Msoxq;
import com.project.model.shopEntity.Pro;
...
public class OrderController {
    ...
    public ShopUser getLoginUser(HttpServletRequest request){
        //初始化session
        HttpSession session = request.getSession();
        //获取session里面的user对象
        ShopUser user = (ShopUser) session.getAttribute("user");
