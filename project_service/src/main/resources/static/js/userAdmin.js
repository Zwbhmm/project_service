new Vue({
    ...
    methods:{
        ...
        getAllUser:function () {
            var _this = this;
            axios.get('/project_service/shopUser/findAll',{
                params:{
        ...
        getUserById:function(userid){
            ...
            var _this = this;
            axios.get('/project_service/shopUser/getUserById/' + userid)
                .then(function (response) {
                    //把返回的集合赋值给userList
        ...
        updateUser:function () {
            var _this = this;
            //根据用户id进行信息更新的操作
            axios.get('/project_service/shopUser/updateUserById/' + _this.user.id,{
                params:{
        ...
        deleteUser:function (userid) {
            ...
            if (confirm("是否确定要删除该用户？")) {
                axios.delete('/project_service/shopUser/deleteByUserid/' + userid)
                    .then(function (response) {
        ...
        getAllUserCount:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/shopUser/getAllUserCount')
                .then(function (response) {
                    //把返回的总页数赋值给这里的总页数
