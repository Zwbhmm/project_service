new Vue({
    ...
    methods:{
        ...
        getProimages:function(event){
            ...
            axios.post('/project_service/pro/uploadpImg',formData,config)
        ...
        getXqimg:function(event){
            ...
            axios.post('/project_service/pro/uploadxqImg',formData,config)
                .then(function (response) {
                    alert(response.data);
                })
                .catch(function (error) {
        ...
        isLogin:function () {
            var _this = this;
            axios.get('/project_service/shopAdmin/isLogin')
                .then(function (response) {
        ...
        loginOut:function () {
            ...
            if (confirm("是否确定要退出当前管理员账号？")){
                axios.get('/project_service/shopAdmin/loginOut')
                    .then(function (response) {
                        if (response.data == "OK") {
                            //刷新当前页面
        ...
        findAll:function () {
            ...
            var _this = this;
            axios.get('/project_service/pro/findAll',{
                params:{
        ...
        getTotalPage:function(){
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/pro/getTotalPage')
                .then(function (response) {
                    //赋值总页数
        ...
        deleteById:function (id) {
            ...
            if (confirm("是否确定要删除该产品？")) {
                axios.get('/project_service/pro/deleteById/' + id)
                    .then(function (response) {
                        if (response.data = "OK") {
                            alert("删除成功！");
                            //刷新页面
        ...
        updateById:function (proid) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/pro/updateById/' + proid, {
                params:{
        ...
        getAllCid:function(){
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/pro/getAllCid')
                .then(function (response) {
                    //根据id获取到的pro产品赋值过来
        ...
        getById:function (proid) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/pro/getProById/' + proid)
                .then(function (response) {
                    //根据id获取到的pro产品赋值过来
        ...
        addPro:function () {
            ...
            axios.get('/project_service/pro/addPro', {
                params:{
