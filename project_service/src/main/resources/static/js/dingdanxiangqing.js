new Vue({
    ...
    methods:{
        ...
        getMsoxq:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getMsoxq')
        ...
        getPageMsoxq:function(){
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/pageMsoxq',{
                params:{
                    //当前页数
        ...
        getMsoxqCountByMsoid:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getMsoxqCountByMsoid')
                .then(function (response) {
                    //给我们的产品总数进行赋值
        ...
        comment:function (proid) {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/comment/setProid/' + proid)
                .then(function (response) {
                    if (response.data == "OK") {
                        //跳转到评论页面
