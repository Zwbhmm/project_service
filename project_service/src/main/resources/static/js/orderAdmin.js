new Vue({
    ...
    methods:{
        ...
        findAll:function () {
            var _this = this;
            axios.get('/project_service/order/findAll',{
                params:{
        ...
        getTotalPage:function(){
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/getTotalPage')
                .then(function (response) {
                    //赋值总页数
        ...
        deleteByMsoid:function (msoid) {
            ...
            if (confirm("是否确定删除该订单？")) {
                axios.get('/project_service/order/deleteByMsoid/' + msoid)
                    .then(function (response) {
                        //赋值总页数
                        if (response.data == "OK") {
                            alert("删除成功！");
        ...
        getMsoxq:function (msoid) {
            ...
            axios.get('/project_service/order/getMsoxqByMsoid_admin/' + msoid)
                .then(function (response) {
        ...
        sendPro:function () {
            //在当前方法中定义一个变量，表明是vue对象
            var _this = this;
            axios.get('/project_service/order/sendPro/' + _this.msoxq.msoid)
                .then(function (response) {
                    if (response.data == "OK") {
                        alert("发货成功！")
                        //重新刷新页面
